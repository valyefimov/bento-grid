...
export const uk: Translation = {
  ...
  ui: {
    ...
    viewCertificateBtn: 'Отримати сертифікат ▶',
    successFeedback: 'Є! Сітку зібрано правильно.',
    errorFeedbackPrefix: 'Поки не те: ',
    certificateBurst: 'МАЙСТЕР\nСІТКИ!',
    certificateTitle: 'СЕРТИФІКАТ\nМАЙСТРА СІТОК',
    certificateBody:
      'Цим засвідчується, що ви підкорили 18 панелей, пережили subgrid майже без сліз і тепер вживаєте "fr" у щоденній мові. minmax() віддає вам честь.',
    certificateSignature: 'Підписано: капітан Каскад, головний інспектор панелей',
    certificateCloseBtn: 'Закрити',
    helpBurst: 'ЧИТАЙ\nСЮДИ!',
    helpTitle: 'Як грати',
    helpSteps: [
  ...
  hints: {
    fixed:
      'Фіксовані колонки (repeat(N, 1fr)) — передбачувана розкладка, гнучко ділить доступний простір.',
    px: 'Колонки в px не розтягуються під контейнер — вільний залишок якраз для place-content.',
    'auto-fit':
      'auto-fit стискає порожні колонки до нуля — панелі розтягуються на всю ширину сторінки.',
